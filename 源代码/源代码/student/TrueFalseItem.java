...
public class TrueFalseItem {
	...
	public TrueFalseItem(JFrame frame,JPanel dopanel,int ID){
		this.frame = frame;
        ...
        truefalse = new ConnectData("TrueFalse",ID);
		rs = truefalse.getResultSet();
		getdonumber();
		getN();
        testSinglechoice();//出题
	}
	...
	private void getN(){
		 ConnectData  singlechoicegetn= new ConnectData("TrueFalse");
	...
	class JRadioButtonA_actionAdapter implements ActionListener{
		private TrueFalseItem adaptee;
		JRadioButtonA_actionAdapter(TrueFalseItem adaptee){
	...
	public void JRadioButtonA_actionPerformed(ActionEvent e){
    	...
    	if(answerlist[number].equals("")){
    		//第一次答此题
    		answerlist[number] = new String("对");
    ...
    class JRadioButtonB_actionAdapter implements ActionListener{
		private TrueFalseItem adaptee;
		JRadioButtonB_actionAdapter(TrueFalseItem adaptee){
			this.adaptee = adaptee;
		}
    	public void actionPerformed(ActionEvent e){
	...
	public void JRadioButtonB_actionPerformed(ActionEvent e){
    	...
    	if(answerlist[number].equals("")){
    		//第一次答此题
    		answerlist[number] = new String("错");
    		vector.addElement("第"+n+"题答案："+answerlist[number]);
            answer.setListData(vector);
    	}else{
    		//修改答案
    ...
    class OKJButton_actionAdapter implements ActionListener{
    	private TrueFalseItem adaptee;
    	OKJButton_actionAdapter(TrueFalseItem adaptee){
    		this.adaptee = adaptee;
    	}
    	public void actionPerformed(ActionEvent e){
    ...
    class nextJButton_actionAdapter implements ActionListener{
    	private TrueFalseItem adaptee;
    	nextJButton_actionAdapter(TrueFalseItem adaptee){
    		this.adaptee = adaptee;
    	}
    	public void actionPerformed(ActionEvent e){
