...
public class TrueItem {
	...
	public TrueItem(Interface frame,JPanel dopanel, int id){
		this.frame = frame;
	...
	private void panel(){
		...
		itemrightt.addItem("对");
		itemrightt.addItem("错");
	...
	class search_actionAdapter implements ActionListener{
		 TrueItem adaptee;
		 search_actionAdapter(TrueItem adaptee){
	 ...
	 public void search_actionPerformed(ActionEvent e){
		 ...
		 if(number.equals("")){
			 ...
			 int i = 0;
			 rs = singleitem.search("TrueFalse",id, "题目编号", number);
			 try{
				while(rs.next()){
					i ++;
					itemmeaningt.setText(rs.getString(2));
					itemrightt.setSelectedItem(rs.getString(3));
	 ...
	 class mind_actionAdapter implements ActionListener{
		 TrueItem adaptee;
		 mind_actionAdapter(TrueItem adaptee){
			 this.adaptee = adaptee;
	    }
	    public void actionPerformed(ActionEvent e){
	 ...
	 class cancel_actionAdapter implements ActionListener{
		 TrueItem adaptee;
		 cancel_actionAdapter(TrueItem adaptee){
			 this.adaptee = adaptee;
	    }
	    public void actionPerformed(ActionEvent e){
	 ...
	 public void cancel_actionPerformed(ActionEvent e){
		 ...
		 if(number.equals("")){
			 ...
			 singleitem.cancel("TrueFalse", "题目编号", number);
			 singleitem.Close();
			 clearRows();
			 showitem(id);
			 itemnumbert.setText("");
	 ...
	 class adding_actionAdapter implements ActionListener{
		 TrueItem adaptee;
		 adding_actionAdapter(TrueItem adaptee){
			 this.adaptee = adaptee;
	    }
	    public void actionPerformed(ActionEvent e){
	 ...
	 class exit_actionAdapter implements ActionListener{
		 TrueItem adaptee;
		 exit_actionAdapter(TrueItem adaptee){
			 this.adaptee = adaptee;
	    }
	    public void actionPerformed(ActionEvent e){
	 ...
	 class save_actionAdapter implements ActionListener{
		 TrueItem adaptee;
		 save_actionAdapter(TrueItem adaptee){
			 this.adaptee = adaptee;
	    }
	    public void actionPerformed(ActionEvent e){
	 ...
	 public void save_actionPerformed(ActionEvent e){
		 ...
		 if(mindoradd == 0){
			 ...
			 singleitem.mind("TrueFalse",id, setstr,"题目编号", number);
		 }else{
			 //添加后保存
			 if(itemmeaningt.getText().trim().equals("")||
				 ...
				 singleitem.adding("TrueFalse", addstr);
			 }
		 }
	 ...
	 private String  getID(){
		 int n = 0;
		 singleitem = new ConnectData("TrueFalse");
